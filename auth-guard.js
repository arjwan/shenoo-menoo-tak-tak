(function () {
  ...
  if (/\/(?:taktak\.html)?$/i.test(location.pathname)) {
    ...
    if (!document.querySelector('link[data-home-mini-tv]')) { var miniTvCss=document.createElement('link'); miniTvCss.rel='stylesheet'; miniTvCss.href='home-mini-tv.css?v=20260913-tvfix-1'; miniTvCss.setAttribute('data-home-mini-tv','1'); document.head.appendChild(miniTvCss); }
    if (!document.querySelector('script[data-home-mini-tv]')) { var miniTv=document.createElement('script'); miniTv.src='home-mini-tv.js?v=20260913-tvfix-1'; miniTv.defer=true; miniTv.setAttribute('data-home-mini-tv','1'); document.head.appendChild(miniTv); }
  }
