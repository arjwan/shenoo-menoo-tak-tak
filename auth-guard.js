(function () {
  ...
  if (/\/(?:taktak\.html)?$/i.test(location.pathname)) {
    ...
    if (!document.querySelector('link[data-home-live-now]')) { var liveNowCss=document.createElement('link'); liveNowCss.rel='stylesheet'; liveNowCss.href='home-live-now.css?v=20260913-1'; liveNowCss.setAttribute('data-home-live-now','1'); document.head.appendChild(liveNowCss); }
    if (!document.querySelector('script[data-home-live-now]')) { var liveNow=document.createElement('script'); liveNow.src='home-live-now.js?v=20260913-1'; liveNow.defer=true; liveNow.setAttribute('data-home-live-now','1'); document.head.appendChild(liveNow); }
