(function(){'use strict';
const links=[['👤','صفحتي الشخصية','profile.html'],['👥','الأصدقاء والطلبات','friends.html'],['💬','الرسائل الخاصة','messages.html'],['☎','المكالمات','calls.html'],['🛠','الخدمات','services.html'],['🚕','النقل والحمل','transport.html'],['🛍','مول العراق','mall.html'],['🤝','الاستشارات','consultations.html'],['🏫','مدرسة سومر الشاملة','school-index.html'],['📣','الإعلانات','ads.html'],['➕','إنشاء إعلان','create-ad.html'],['🏆','التحديات والبث','challenges.html'],['☕','كهوة عزاوي','game-room.html'],['🎙','تعال نسولف','taal-nsolf.html'],['🔮','ركن أم عباس','umm-abbas.html'],['☪','الصفحة الإسلامية','islamic.html'],['✨','صديقي الذكي','#smart-friend'],['⚙','الخصوصية والإعدادات','settings.html']];
